...
LDFLAGS=-shared -Wl,-rpath,-Wl/home/sq/lib
...
LIBS=-latscppapi -ltsutil -Wl,-Bstatic -laprutil-1 /home/sq/lib/apr-util-1/apr_crypto_openssl.a -lapr-1 -Wl,-Bdynamic -lcrypt -lstdc++ -lpthread -ldl
